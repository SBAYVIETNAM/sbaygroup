    ...
    <>
      ...
      <div className=' flex flex-col'>
        <div className=" w-full flex flex-col mb-10 max-w-7xl mx-auto">
          <h1 className=' text-4xl font-bold text-center mt-24 text-red-600'>Facebook Group Marketing</h1>
          ...
          <div className=' grid grid-cols-1 lg:grid-cols-2'>
            ...
            <div className=' py-20 px-5'>
              ...
              <div className='p-10'>
                <div className="flex flex-row btn rounded-full bg-red-500 text-white mx-auto mt-5"><p className='flex flex-row mx-auto'><Icon.Play className='w-4 h-4 mt-1' />Chạy</p> </div>
              </div>
            </div>
