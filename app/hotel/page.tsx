      ...
      <div className="container mx-auto">
        <div className="w-full py-10 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-red-600 text-2xl font-extralight py-4">
              KHÁCH SẠN SBAY HOTEL
            </p>
            <p className="text-black text-5xl font-medium pb-4">
              Tận hưởng trải nghiệm sang trọng
            </p>
            <p className="md:text-stone-500 text-lg normal pb-2">
          ...
          <div className="p-10">
            <div className="w-full border-slate-200 border-2 h-[80%]">
              <iframe
        ...
        <div className="w-full py-10 grid grid-cols-1 md:grid-cols-3 gap-4">
